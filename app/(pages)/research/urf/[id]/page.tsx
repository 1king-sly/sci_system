        ...
        <div className='flex flex-row'>
            <div className='w-[14vw] border-2 mx-2'>
                ...
                <div className='px-3 my-3'>
                    ...
                    <Link href={''}><h1 className='mb-3 text-sm text-sky-500 hover:text-sky-300'>Masinde Muliro University of Science and Technology </h1></Link>
                    <Link href={''}><h1 className='mb-3 text-sm text-sky-500 hover:text-sky-300'>National Research Institute</h1></Link>
                    <Link href={''}><h1 className='mb-3 text-sm text-sky-500 hover:text-sky-300'>Health IT</h1></Link>
                    <Link href={''}><h1 className='mb-3 text-sm text-sky-500 hover:text-sky-300'>Ministry of Health</h1></Link>
                </div>
                <div className='px-3 my-3'>
