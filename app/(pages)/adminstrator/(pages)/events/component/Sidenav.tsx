...
export default function Sidenav() {
  ...
  const links =[
    {
    name:'Upcoming Events',href:'/adminstrator/events/#upcoming',id:'upcoming'
  },
    {
    name:'General Announcements',href:'/adminstrator/events/#general',id:'general'
  },
    {
    name:'GDSC Events',href:'/adminstrator/events/#gdsc',id:'gdsc'
  },
    {
    name:'Health IT Events',href:'/adminstrator/events/#healthIT',id:'healthIT'
  },
    {
    name:'ACS Events',href:'/adminstrator/events/#acs',id:'acs'
  },
