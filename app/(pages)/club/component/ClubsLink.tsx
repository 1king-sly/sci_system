...
export default function ClubsLink() {
  return (
    ...
    <div className="relative px-4 sm:px-0 ">
        ...
        <div className="relative grid mx-auto overflow-hidden  bg-white divide-y rounded shadow sm:divide-y-0 sm:divide-x sm:max-w-screen-sm sm:grid-cols-4 lg:max-w-screen-md">
        ...
        <div className="inline-block p-8 text-center">
            ...
            <p className="font-bold tracking-wide text-gray-800">Internet of Things</p>
            <div>
                <a
                  href="/"
                  className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-sky-400 focus:shadow-outline focus:outline-none"
