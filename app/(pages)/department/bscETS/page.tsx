...
export default function page() {
  return (
    <div className='w-full mx-20 my-10'>
        <h1 className='text-xl font-bold my-3'>Bachelor of Technology Education (Computer Studies) </h1>
        ...
        <h1>Mean Grade C+ (Plus) at KCSE with at least C+ in Physics/
            Mathematics and ONE teaching subject or Mean grade C
            (Plain) or its Equivalent with Diploma in relevant Technical
            Education from a recognized Institution</h1>
    </div>
  )
