...
export default function page() {
  return (
    <div className='w-full mx-20 my-10'>
        ...
        <p className=''>A Bachelor of Science in Information Technology, (abbreviated BSIT or B.Sc. IT), is a bachelor's degree awarded for an undergraduate program in the information technology. The degree is normally required in order to work in the Information technology industry.
        ...
        <h1>Mean grade of C+ (plus) at KCSE with C+ (plus) in Mathematics,
          Physics or physical sciences 2 principal passes at A-level, 1
          of which must be in Mathematics or Science subject, Or Any
