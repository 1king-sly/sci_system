...
<main className=" h-full w-full overflow-x-hidden bg-gray-100 dark:bg-gray-800 [&::-webkit-scrollbar]:hidden">
    <div className="flex items-start justify-between">
      
        <div className="flex flex-col w-full md:space-y-4 py-2">
          
            <div className="h-full px-4 pb-24 overflow-auto md:px-6">
                <h1 className="text-4xl font-semibold text-gray-800 dark:text-white">
                    Good afternoon
                </h1>
                <h2 className="text-gray-400 text-md">
                    Here&#x27;s what&#x27;s happening with the sci system.
                </h2>
