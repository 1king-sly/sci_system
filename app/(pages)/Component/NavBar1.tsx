  ...
  return (
    ...
    <div className='w-full flex items-center h-[30vh] md:h-auto font-serif z-50 fixed bg-gray-900 '>
      <div className='w-full h-full mx-auto py-5 px-4 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 flex items-center'>
        ...
        <Link href="/events">
          <h1 className={clsx(`cursor-pointer after:content-[""] after:w-0 after:h-0.5 after:m-auto after:bg-white after:block after:duration-500 hover:after:w-full`,{'after:w-full': pathname === '/events'})}>EVENTS</h1>
        </Link>
        <Link href="/research">
          <h1 className={clsx(`cursor-pointer after:content-[""] after:w-0 after:h-0.5 after:m-auto after:bg-white after:block after:duration-500 hover:after:w-full`,{'after:w-full': pathname === '/research'})}>RESEARCH</h1>
        </Link>
        {/* <Link href="#"> */}
