...
export default function Programs() {
  return (
    <div id="Programmes" className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
        DEPARTMENT OF COMPUTER SCIENCE PROGRAMMES  
        </h2>
        <p className="text-left text-gray-700 lg:text-lg">
    ...
    <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Bachelor of Science (Computer Science)</h6>
        ...
        <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Bachelor Of Technology Education (Computer Studies)</h6>
            <p className="mb-3 text-sm text-gray-900">
        ...
        <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Bachelor of Science (Computer Security and Forensics)</h6>
            <p className="mb-3 text-sm text-gray-900">
